          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (Context)=> gender_screen(),));
                    },
                    child: Container(
                        ...
                        child: Text("Done",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 17),)),
                  ):
                  GestureDetector(
                    onTap: (){
